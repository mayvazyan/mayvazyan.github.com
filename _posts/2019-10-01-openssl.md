...
I was a bit surprised then build failed with **Invalid provider type specified** error. 
For some reason it was failing to sign **Click Once** manifest. 
What's interesting **signtool.exe** was able to use that certificate just fine…
